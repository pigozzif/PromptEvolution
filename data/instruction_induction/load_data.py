...
induce_data_path = os.path.join(os.path.dirname(__file__),
                                '../../automatic_prompt_engineer/experiments/data/instruction_induction/raw/induce/')
eval_data_path = os.path.join(os.path.dirname(__file__),
                              '../../automatic_prompt_engineer/experiments/data/instruction_induction/raw/execute/')
